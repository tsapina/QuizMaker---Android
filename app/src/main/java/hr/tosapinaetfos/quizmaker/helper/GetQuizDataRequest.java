 ...
 */
public class GetQuizDataRequest extends StringRequest {

    //Request URL , Genimotion localhost adress and port
    private static final String REGISTER_REQUEST_URL = "http://www.etfos.unios.hr/~tsapina/GetQuizData.php"; // adresa preko koje genimotion moze pristupiti localhostu

    //Map for saving data and sending them as a params; <key,value>
    private Map<String, String> params;

    public GetQuizDataRequest(String strQuizKey, Response.Listener<String> listener, Response.ErrorListener errorListener) {
